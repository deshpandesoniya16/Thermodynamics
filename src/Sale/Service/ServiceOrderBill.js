...
class ServiceOrderBill extends Component {
...
this.setState({ItemName:"",ItemCost:"",ItemQty:0,ItemUnitPrice:0,ItemGST:0,ItemDiscount:0,TaxableValue:0,AddItem:false})
  ...
  <PageContainer2 style={{ height: "100vh" }}>
          <div style={{ display: "flex", borderBottom: "2px solid #863577" }}>
            <Link to="/ServiceOrderInvoice">
              <IconDiv>
                <Icon name="arrow left" />
              </IconDiv>
            </Link>
            <HeadingDiv>
              <HeadingText>Service</HeadingText>
            </HeadingDiv>
          </div>
          ...
          <ContentArea style={{ justifyContent: "center" }}>
            <TableDiv>
              ...
              >
                <font color="white">Add Service</font>
              </Button>
          ...
          {this.state.redirectTocart && <Redirect to="/ServiceOrderCart" />}
        </PageContainer2>
                                  ...
                                  <Grid.Column>
                                    ...
                                    <Form.Group widths="equal">
                                      <input
                                        ...
                                        placeholder="Enter Service Qty Here"
                                        style={formInput}
                                      />
                                    </Form.Group>
                                ...
                                <Grid relaxed columns={3} centered>
                                  ...
                                  <Form.Group widths="equal">
                                      <input
                                        ...
                                        placeholder="Enter Service Unit Price Here"
                                        style={formInput}
                                      />
                                    </Form.Group>
                                  </Grid.Column>
                              ...
                              <Grid relaxed columns={3} centered>
                                  ...
                                  <Form.Group widths="equal">
                                      <input
                                        ...
                                        placeholder="Enter Service Discount Here"
                                      style={formInput}
                                      />
                                    </Form.Group>
                                  </Grid.Column>
...
*/}
                                  ...
                                  <Form.Group widths="equal">
                                      <input
                                        ...
                                        placeholder="Enter Service Gst Here"
                                        style={formInput}
                                      />
...
export default ServiceOrderBill