...
import {clientList,createServiceOrder} from "../../component/Api"
...
class ServiceOrderPaymentBill extends Component {
...
// }
    ...
    render(){
        ...
        return(
          ...
          {this.state.redirectToInvoice && <Redirect to="/service" />}
...
export default ServiceOrderPaymentBill