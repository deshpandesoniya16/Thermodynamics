...
import {clientList,vendorGodview} from "../../component/Api"
...
class ServiceOrderInvoice extends Component {
  ...
  render() {
   ...
   <PageContainer2>
          <div style={{ display: "flex", borderBottom: "2px solid #863577" }}>
            ...
            <HeadingDiv>
              <HeadingText>Add Services</HeadingText>
            </HeadingDiv>
          </div>
          <ContentArea>
          ...
          {this.state.redirectToBill && <Redirect to="/ServiceOrderBill" />}
        </PageContainer2>
