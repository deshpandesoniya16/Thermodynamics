...
class QuoatationBill extends Component {
      ...
      if (query.search(/[^a-zA-Z]+/) === -1) {
        ...
        return(
          ...
          <div style={{ display: "flex", borderBottom: "2px solid #863577" }}>
            ...
            <HeadingDiv>
              <HeadingText>Quoatation Items</HeadingText>
            </HeadingDiv>
          </div>
          ...
          {this.state.redirectTocart && <Redirect to="/QuoatationCart" />}
        </PageContainer2>
