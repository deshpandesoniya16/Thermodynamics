...
import { perFormaList } from "../../component/Api"
import {
  PageContainer,
  IconDiv,
  HeadingDiv,
...
class PerformaGodView extends Component {
  state = {
    menuVisible: false,
    startdate: "",
    dataList: [],
  ...
  performaGodsview = () => {
    fetch(perFormaList, {
      ...
      .then(data => {
        ...
        if (data.records) {
          this.setState({ performaData: data.records })
        } else {
          console.log("No Invoice ")
          this.setState({ performaData: [] })
        }
      })
  }

  componentDidMount() {
    this.performaGodsview()
  }
      ...
      <div>
        <PageContainer>
          <div style={{ display: "flex", borderBottom: "2px solid #863577" }}>
            ...
            <HeadingDiv>
              <HeadingText>Perfoma God's View</HeadingText>
            </HeadingDiv>
          </div>
...
export default PerformaGodView
