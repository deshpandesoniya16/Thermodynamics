...
import {clientList,createPerforma} from "../../component/Api"
...
class PerformaBillpayment extends Component {
...
calculateGst = (charges) =>{
 ...
 <PageContainer2 style={{ height: "100vh" }}>
          ...
          {this.state.redirectToInvoice && <Redirect to="/performa" />}
...
export default PerformaBillpayment