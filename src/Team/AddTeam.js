...
handleRemove = (i) =>{
  ...
  handleSubmit = () => {
    ...
    if (!this.state.uploadedfileurl) {
      this.setState({msg1:"Please upload photo"})
      ...
      fetch("http://35.161.99.113:9000/webapi/t_team/addTeamMember", {
        method: "POST",
        headers: {
        ...
        .then(data => {
          ...
          if (data.message == "User Added") {
            ...
            let message = "hi you are added in team."
            let url =
  ...
  handleChangeUsername = (event) => this.setState({username: event.target.value});
        ...
        handleUploadSuccess = (filename) => {
          ...
          MyTeam_fbs.child(filename).getDownloadURL().then(url =>{
  ...
  render() {
    ...
    let {
      ...
      isbtn,isSucess,btndisable,
    } = this.state

    console.log("Selected Result", TeamImageData)
      ...
      <div>
        ...
        <PageContainer2>
          <div style={{ display: "flex", borderBottom: "2px solid #863577" }}>
            ...
            <HeadingDiv>
              <HeadingText>Add Team</HeadingText>
            </HeadingDiv>
          </div>
          <ContentArea>
            <TixyContent>
