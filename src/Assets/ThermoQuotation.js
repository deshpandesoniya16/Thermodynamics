...
class ThermoQuotation extends Component {
  ...
  render() {
    ...
    return (
        ...
        <div>
            <div id="demo">
            <center>
                <h4 style={{marginTop: "2%",}}>Quotation</h4>
            </center>
                ...
                <Table celled Fixed singleLine >
                    <Table.Header>
                        <Table.Row>
                            ...
                            {/* <Table.HeaderCell style={tableStyle}>Part No</Table.HeaderCell> */}
...
export default ThermoQuotation;
