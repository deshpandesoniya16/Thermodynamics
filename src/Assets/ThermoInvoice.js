...
class ThermoInvoice extends Component {
    ...
    componentDidMount(){
        ...
        let inv_id = sessionStorage.getItem("invoiceID")
        ...
        console.log("word amt",w_amt)
            ...
            this.setState({BillAddr:billaddr,invoiceID:inv_id,ShipAddr:shipaddr,TotalAmount:t_amt,WordAmt:w_amt})
  ...
  render() {
    ...
    const {
        invoiceData,
        clientData,invoiceID,
        BillAddr,ShipAddr,dDate,dno,pdate,po,TotalAmount,cuurentDate,WordAmt
    }=this.state
    ...
    return (
        ...
        <div>
            <div id="demo">
            <center>
                <h4 style={{marginTop: "2%",}}>Tax Invoice</h4>
            </center>
            <Container style={outline}>
                ...
                <Grid>
                    <Grid.Row>
                        <Grid.Column width={8}>
                            <p>Client Name : {clientData.company_name} </p>
                ...
                <Table celled Fixed singleLine >
                    ...
                    <Table.Body>
                        ...
                        <Table.Row>
                            ...
                            <Table.Cell >{i.unitPrice}</Table.Cell>
                            <Table.Cell >{i.discount}</Table.Cell>
