...
class VendorTransmute extends Component {
...
<label htmlFor="radio2">disburse</label>               
                     ...
                     />
                       ...
                       <p><font color="red">{this.state.panmsg}</font></p>
                       ...
                       <p><font color="red">{this.state.gstmsg}</font></p>
                     ...
                     <p style={{ color: "red" }}>{this.state.message}</p>
                           ...
                           {this.state.redirectToBilling && <Redirect to="/VendorBillingInfo" />}
                           </div>
...
export default VendorTransmute
