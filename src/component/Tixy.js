          ...
          >
            <PageContainer>
              ...
              >
                ...
                <HeadingDiv>
                  <HeadingText>Tixy God's View</HeadingText>
                </HeadingDiv>
              </div>
              <Scrollbars style={{ display: "flex", flex: 1, height: 500 }}>
                <ContentArea>
                                    ...
                                    switch (props.datum.id) {
                                      case 'hold':
                                        ...
                                        if (props.datum.eventKey != 0) {
                                          ...
                                          this.setState({ flag: true, listData: OnHoldCount })
                                        ...
                                        break;
                                      case 'UnderProgress':
                                        if (props.datum.id == "UnderProgress") {
                                          this.setState({ flag: true, listData: UnderProgressCount })
                                          console.log("flag", flag)
                                      ...
                                      case 'Rejected':
                                        if (props.datum.id == "Rejected") {
                                          this.setState({ flag: true, listData: rejectedCount })
                                          console.log("flag", flag)
                                      ...
                                      case 'Closed':
                                        if (props.datum.id == "Closed") {
                                          this.setState({ flag: true, listData: ClosedCount })
                                          console.log("flag", flag)
                  ...
                  <TableDiv>
                    ...
                    <div style={{ backgroundColor: "white", marginLeft: "150px" }}>

                      <ReactTable
                        data={listToShow}
                        style={{ width: 900 }}
                        getTrProps={this.onRowClick}          //Aishwarya 28 may
                        filterable
                        ...
                        columns={[

                          {
                            ...
                            columns: [
                              ...
                              {
                                Header: <strong>Ticket Owner</strong>,
                                id: "aname",
                                accessor: d => d.aname,
                                filterMethod: (filter, rows) =>
                                  matchSorter(rows, filter.value, { keys: ["aname"] }),
                                filterAll: true
                              },
                              // {
            ...
            {this.state.redirectToEdit && <Redirect to="/EditTixy" />}
