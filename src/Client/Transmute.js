...
class Transmute extends Component {
...
const{
   ...
   totalgst,
    ...
    tin,
    CST,
    panno,ECC,Excise,Collectorate,State,place_Of_Supply
}=this.state
...
/>&nbsp;&nbsp;
<label htmlFor="radio1">New Lead</label>              
...
onChange={this.handleMachnie}
/>
<label htmlFor="radio2">Asset owner</label>               
...
onChange={this.handleMachnie}
/>
<label htmlFor="radio2">Product owner</label>
</Form.Group>
</center>
                       <Segment>
                     ...
                     />
                       ...
                       <Header as="h4">gst No.:</Header>
                         <div className="space"></div>
                         <input placeholder='Enter GST No. number' 
                         value={gstno}
...
<Form.Group  widths={1}>
<select value={place_Of_Supply} onChange={this.handlePlace}>
<option value="" disabled selected hidden>
                  Select Place Of Supply
</option>
{State.map(i=>(
<option value={i.state} key={i.state}>{i.state}</option>
))}
</select>
