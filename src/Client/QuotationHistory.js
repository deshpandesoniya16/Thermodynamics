...
class QuotationHistory extends Component {
      ...
      <Sidebar.Pusher onClick={() => this.state.menuVisible && this.setState({ menuVisible: false })} dimmed={this.state.menuVisible}>
          <Segment>
                  <Container>   
                      ...
                      <br/>
                      <Header as="h3">Quotation History</Header>
                      </center>
                          <br/>
                      ...
                      <Grid  columns={3}>
                              ...
                              <Link to="/InvoiceHistory"><Icon name="reply" color="black" size="big"/></Link>
                              </div>
                              ...
                              <Table.HeaderCell style={tableStyle}>Status</Table.HeaderCell>
